        ...
        <div class="w-100 flex justify-between px-8 py-8 align-middle text-white">
          <div>
            <p class="text-lg font-semibold">
              Hi, I'm <span class="text-xl text-green-400">Waleed</span>
            </p>
          ...
          <div class="w-100 relative flex min-w-[300px]">
            ...
            <div class="absolute left-0 top-0 h-80 w-[300px] rotate-6 rounded-xl bg-green-400" />
            <img
              class="absolute left-0 top-0 h-80 rounded-xl border-2 border-green-400"
